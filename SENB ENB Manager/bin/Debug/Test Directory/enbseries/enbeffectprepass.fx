...
float	fCloseDofDistance
<
	string UIName="DoF: Close Dof Distance";
	string UIWidget="Spinner";
	float UIStep=0.001;
	float UIMin=0.000;
	float UIMax=1.0;
...
float	fBokehCurve
<
	string UIName="Bokeh: Bokeh Curve";
	string UIWidget="Spinner";
	float UIStep=0.01;
	float UIMin=0.00;
	float UIMax=10.0;
...
float	fBokehIntensity
<
	string UIName="Bokeh: Bokeh Intensity";
	string UIWidget="Spinner";
	float UIStep=0.01;
	float UIMin=0.00;
	float UIMax=10.0;
...
float	fBokehConstant
<
	string UIName="Bokeh: Bokeh Constant";
	string UIWidget="Spinner";
	float UIStep=0.01;
	float UIMin=0.00;
	float UIMax=10.0;
...
float	fBokehMaxLevel
<
	string UIName="Bokeh: Bokeh Max Level";
	string UIWidget="Spinner";
	float UIStep=0.01;
	float UIMin=0.00;
	float UIMax=100.0;
...
float	fBokehMaxWeight
<
	string UIName="Bokeh: Bokeh Max Weight";
	string UIWidget="Spinner";
	float UIStep=0.01;
	float UIMin=0.000;
	float UIMax=100.0;
...
float	fGrainFreq
<
	string UIName="Grain: Grain Frequency";
	string UIWidget="Spinner";
	float UIStep=0.1;
	float UIMin=0.0;
	float UIMax=5000.0;
...
float	fGrainScale
<
	string UIName="Grain: Grain Scale";
	string UIWidget="Spinner";
	float UIStep=0.0001;
	float UIMin=0.0000;
	float UIMax=1.0;
...
#define fChromaPower 8.0						// power of the chromatic displacement (curve of the 'fvChroma' vector)
...
//#define fBlurCutoff 0.15					    // bluring tolerance depending on the pixel and sample depth (smaller causes objects edges to be preserved)
//#define fCloseDofDistance 0.05					// only to this distance DoF will be applied
...
// Grain parameters                             // change SEED constant - Timer.w to animate, 1.0 for static
//#define fGrainFreq 1000.0						// image grain frequency
//#define fGrainScale 0.0015						// grain effect scale
